/*
* Linux 5.4.x port for the New-CWV implementation for Linux: draft-ietf-tcpm-newcwv-05.txt
* Original New CWV implementation provided by Ziaul Hossain and Raffaello Secchi
*
* --------------------------------------------------------------------------------
*
